...
// enumerations are a collection of posssible values something can be
enum CardSuits{
...
int GenerateRandomNumber(int min, int max){
    // static is used so we only calculate this value once
    static const double fraction = 1.0/(static_cast<double>(RAND_MAX) + 1.0);
    // evenlt distribute the random number across our range
...
int main(){
    // set the initial seed value to system clock
